...
import { FaAngleDown, FaPlay, FaPlus, FaStop } from "react-icons/fa";
        ...
        <div className="lg:max-w-half w-full flex flex-col gap-10 justify-center items-center">
            ...
            {sets.length !== 0 ? (
              sets.map((set, _) => (
                <div
                  ...
                  style={{
                    background:
                      set?.id === currentSet?.id ? "#99BBAD" : "#C8E3D4",
                  }}
                >
                  {set.duration} mins
                  <div
          ...
          <div>
            ...
            >
              ...
              <FaAngleDown
                style={{
                  transform: accordian ? "rotate(180deg)" : "rotate(0)",
                }}
              />
            </span>
            <div
              className={`w-max overflow-hidden mx-auto ${
                accordian ? "max-h-screen" : "max-h-0"
              }`}
            >
              <form className="flex overflow-hidden rounded bg-orange-400 border-gray-300 border border-solid focus:outline-none">
                ...
                <button
                  onClick={addSet}
                  className="inline-block flex items-center justify-center gap-3 rounded p-3 flex-1"
                >
                  <FaPlus />
                  Add Set
                </button>
              ...
              <div className="flex justify-center gap-1 mt-3">
                <button
                  className="py-3 px-3 flex items-center justify-center gap-3 rounded bg-lime-400 hover:bg-lime-400/60 w-full min-w-max"
                ...
                <button
                  className="py-3 px-3 flex items-center justify-center gap-3 rounded bg-red-400 hover:bg-red-400/60 hover:text-black w-full min-w-max"
                  onClick={(e) => {
                    e.preventDefault();
                    clearTimer(timerId).catch((err) =>
